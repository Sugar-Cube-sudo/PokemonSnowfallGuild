...
import { Eye, EyeOff, Lock, User, Snowflake, Shield, UserPlus } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { LoginRequest, RegisterRequest } from '@/types/auth';
import { DEFAULT_ADMIN, validatePasswordStrength } from '@/lib/auth';
...
export default function LoginPage({ onLoginSuccess }: LoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isRegisterMode) {
      ...
      if (result.success) {
        onLoginSuccess(false); // 注册成功后直接登录，不需要修改密码
      }
    } else {
      // 登录逻辑
  ...
  const toggleMode = () => {
    ...
    setRegisterData({ gameNickname: '', password: '', confirmPassword: '', avatar: null });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/20 p-8">
          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={toggleMode}
                className="flex items-center space-x-2 mx-auto px-4 py-2 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
              >
                {isRegisterMode ? (
                  <>
          ...
          {/* 默认账号提示 - 仅在登录模式显示 */}
          <AnimatePresence>
            {!isRegisterMode && !showDefaultHint && (
              <motion.div
              ...
              {isRegisterMode && (
                ...
                >
                  ...
                  <AvatarUpload
                    ...
                    currentAvatar={registerData.avatar ? URL.createObjectURL(registerData.avatar) : null}
            ...
            >
              ...
              <div className="relative">
                ...
                <motion.input
                  ...
                  type="text"
                  value={isRegisterMode ? registerData.gameNickname : formData.username}
                  onChange={(e) => isRegisterMode ? handleRegisterInputChange('gameNickname', e.target.value) : handleInputChange('username', e.target.value)}
                  ...
                  placeholder={isRegisterMode ? '请输入游戏昵称' : '请输入用户名'}
                  required
                />
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative">
                ...
                <motion.input
                  ...
                  onChange={(e) => isRegisterMode ? handleRegisterInputChange('password', e.target.value) : handleInputChange('password', e.target.value)}
